...
class Main2 {
    public static void main(String[] args) throws IOException, InterruptedException {
        GetAllCommentsFromLastPostByUserId comments = new GetAllCommentsFromLastPostByUserId();
        comments.getAllCommentsFromLastPostByUserId(1);
    }
}

class GetAllCommentsFromLastPostByUserId {
    HttpClient client = HttpClient.newHttpClient();

    public void getAllCommentsFromLastPostByUserId(int userId) throws IOException, InterruptedException {
        String allPosts = getPostsByUserId(userId);
        List<String> postsIds = findAllMatches(allPosts);
    ...
    private int findNumberFromString(String text) {
